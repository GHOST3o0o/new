<?php
	...
	If ($match !== 1) {
		header('Location: http://www.satori-marketing.com/indexTest.php?msg=Please enter a valid Zip Code.');
		exit;
	}
?>
...
<div class="container_24">
    ...
    <div class="clear" ></div>
	<div class="grid_24">
    	<center>Click on business card to view the Business web site.</h6></center>
    </div>
    <div class="clear" ></div>
