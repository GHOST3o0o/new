<?php
	...
	If ($match !== 1) {
		header('Location: http://www.satori-marketing.com/indexDemo.php?msg=Please enter a valid Zip Code.');
		exit;
	}
?>
...
<div class="container_24">
    ...
    <div class="grid_1" >
  	...
  	<div class="grid_7" >
    	<?php
    		$url = "http://www.satori-marketing.com/indexDemo.php";
   			 echo "<a href='$url'><p><b>Change Service Category and/or Zip Code</b></p></a>";
		?> 
    </div>
    <div class="clear" ></div>
	<div class="grid_24">
    ...
    <div class="clear" ></div>  
        ...
        <div class="grid_10" >
            ...
            ?>
               ...
               If ($vLink99 == "Skip") {
                            ?> 
                            <img class="BC" width="350px" src="<?= $vImageDisplay99 ?>" >
                    <?php
                        }
                Else {
                    ?>
                        <a href="<?= $vLink99 ?>" target="_blank" ><img class="BC" width="350px" src="<?= $vImageDisplay99 ?>" ></a>
                    <?php
                        }
                    ?>
