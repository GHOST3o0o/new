...
Else
{
	...
	<?php		  
 	...
 	<?php }
		...
		<div class="BCcontent">
        	<div class="BCard2I">
            	<img width="282px" height="150px" src="<?= $vImageDisplay2 ?>" >
    		</div>

	<?php		  
		  }	  
		If ($vCard3 == 1 And $vDoImage3 == "No") {
			?>         
            <div class="BCard3">
                <h1><?= $vName3 ?></h1>                
 	...
 	<?php }
		...
		<div class="BCcontent">
        	<div class="BCard3I">
            	<img width="282px" height="150px" src="<?= $vImageDisplay3 ?>" >
    		</div>
	<?php		  
		  }
		  	  
		If ($vCard4 == 1 And $vDoImage4 == "No") {
			?>           
            <div class="BCard4">
                 <h1><?= $vName4 ?></h1>                
 	...
 	<?php } 
		...
		<div class="BCcontent">
        	<div class="BCard4I">
            	<img width="282px" height="150px" src="<?= $vImageDisplay4 ?>" >
    		</div>
	<?php		  
		  }	
}
