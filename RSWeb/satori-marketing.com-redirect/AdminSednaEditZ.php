  ...
  <div class="tallcontent">
    <h1>Coeur d'Alene Area Referral System Administration Program</h1>
     ...
     <table Table width="90%" align="center">
    	...
    	<tr>
        	<td style="width:20%" >Zipcode</td> <td style="width:50%"><a href="AdminSednaEditZSort.php" >Description</a></td><td style="width:10%">&nbsp;</td><td style="width:20%" align="center">Delete</td>
        </tr>
     ...
     ?>
     	<tr>
        	<td><input type="text" size="6" maxlength="5" name="<?= $row['ID_zipcode']; ?>" value="<?= $row['Zipcode']; ?>" > </td>
